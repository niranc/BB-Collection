...
# Grap a scop file (with all wildcards)
...
install_tools () {
	...
	mkdir tools/xray
	mv xray_linux_amd64 ./tools/xray/xray
	mv *.yaml ./tools/xray/
	rm xray*.zip
